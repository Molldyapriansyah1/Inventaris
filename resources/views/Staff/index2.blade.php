        ...
        <div class="modal-content" style="border-radius: 12px; border: none; box-shadow: 0 10px 25px rgba(0,0,0,0.1);">
            <form action="{{ route('staff.export') }}" method="GET">
                ...
                <div class="modal-header" style="border-bottom: 1px solid #f5f5f5; padding: 20px 24px;">
                    <h5 class="modal-title" id="exportModalLabel" style="font-weight: 700; color: #1a1a1a;">Export Operator Accounts</h5>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex gap-4">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="exportAll" style="font-size: 14px; cursor: pointer;">All Operator Accounts</label>
                            </div>
                            <div class="form-check">
